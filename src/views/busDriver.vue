...
<script type="text/ecmascript-6">
    ...
    import add from "../components/addBusDriver.vue";
    import newAdd from "../components/addBusEmployeeDriver.vue";
    let staffsOps = null;
        ...
        methods: {
            ...
            deleteBtn: function (id) {
                ...
                layer.confirm('删除须谨慎，确认要删除吗？', (index)=> {
                    this.itemsLoading = true;
                    $.ajax({
                        url: `${base.gAjaxUrl.shuttlebusdrivers}${id}/`,
                        type: 'DELETE',
                    }).always((data)=> {
                        this.itemsLoading = false;
                        if (data) {
            ...
            toggleLock: function (bus) {
                this.itemsLoading = true;
                $.ajax({
                    url: base.gAjaxUrl.shuttlebusdrivers + bus.id + '/',
                    type: 'PATCH',
