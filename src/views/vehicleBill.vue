<template>
    <details v-if="isShowDetails"  :start="startDateInput" :end="endDateInput" :state="fliterType" :item="detailsData"></details>
    ...
    export default{
        ...
        methods:{
            ...
            queryAjax:function(callback=function(){}){
                ...
                //修改参数
                $.ajax({
                    url: `${base.gAjaxUrl.officialCarFees}statlist/`,
                    type: 'GET',
                    data:{
            ...
            exportBill:function () {
                    ...
                    let ajaxData = {
                     ...
                     $.ajax({
                        url: `${base.gAjaxUrl.officialCarFees}statlist_export/`,
                        type:'GET',
                        data:ajaxData
                    }).always((data)=>{
                        base.ajaxCallback(data,()=>{
