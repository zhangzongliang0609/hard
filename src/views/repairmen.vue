    ...
    <section class="Hui-article-box">
        <div class="page-container bgc-f5">
            <div class="panel panel-default radius">
				<div class="panel-body f-20 fw-b">维修人员管理</div>
			</div>
            <div class="bk-gray radius mt-10 bgc-fff">
                <div class="pd-15 clearfix">
                    <div class="text-l clearfix f-l mr-15">
                        <input id="searchInput" autocomplete="off" type="text"  placeholder="名字/工号/手机号" style="width:250px" class="f-l input-text">
                ...
                <table class="table table-border table-bg table-striped">
                    ...
                    <tbody>
                        <tr class="text-c" v-for="item in items">
                            ...
                            <td>
                                <a title="删除" href="javascript:;" class="ml-5" v-on:click="deleteRepairmen(item.id)"><i class="Hui-iconfont">&#xe6e2;</i></a>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
<script>
    ...
    import add from "../components/addRepairmen.vue";
        ...
        methods: {
            ...
            deleteRepairmen:function(id){
                ...
                layer.confirm('删除须谨慎，确认要删除吗？',(index)=>{
                    ...
                    $.ajax({
                        url: `${base.gAjaxUrl.repairmen}${id}/`,
                        type: 'DELETE',
                    })
                    .always((data)=>{
