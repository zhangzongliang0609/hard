<template>
    ...
    <!-- <div id="move" class="move layui-layer layui-layer-page layui-modify layui-modify1"> -->
        <div class="text-c layui-layer-title layui-layer-title1 layui-layer-title-two">
            ...
            <!-- <div class="float-full">1243</div> -->
        </div>
        <div id="heightprcent" class="heightprcent">
            <div id="divclass" class="divclass1 col-xs-6 col-sm-6 col-md-6 col-lg-6 f-l" style="overflow:auto;overflow-y:hidden;width: 55%; height: 95%;">
            ...
            <div class="text-c pl-5 pr-10 rightheight col-xs-6 col-sm-6 col-md-6 col-lg-6 f-l">
                <div class="circle">
                ...
                <div class="f-l div-bottom mt-5" style="width: 100%;">
                    <div class="text-c f-22">
                        <div class="text-c layui-layer-title layui-layer-title-bottom  f-24">
                            ...
                            <div id="order_change_count"  class="text-c f-24 f-l c-color-orderdetails">{{ order_change_count }}</div>
                            <div class="f-l f-24">)</div>
                        </div>
                    </div>
                    <div id="div_scroll" class="div-scroll" style="overflow:auto; width: 100%; overflow-y:hidden; height: 91%;">
                        <table  class="tableclass1 table table-hover table-border table-bordered table-bg thead-padding thead-height-wait  table-striped radius" >
                            <thead class="radius table-thead">
                                <tr class="text-c trborder">
    ...
    export default{
        ready () {
            ...
            function orderFn(number_order){
                ...
                // 传不同状态值调出表格的数据
                that.getOrderNumber(orderStatusArray[j],function(){
                    // 动态修改当天订单的总数内容
                    ...
                    vm.order_change_count = vm[arrayValue[j]]
                });
            ...
            this.circleNumber(50,orderFn);
            let that = this;
            // $("#tabConReal").on('click',function(){
            ...
            let arrayValue = ["running_order_cnt", "finished_order_cnt", "cancel_order_cnt"]
            ...
            function autoPlay() { 
                ...
                // 开始向上滚动
                tableh.style.top =73 + num + "px";
                table_bottomh.style.top =26 +  num2 + "px";  
            }
            ...
            // that.circleNumber(50);
            // 定时向上滚动
            window.timesTdody = setInterval(autoPlay,100);
            // window.onload=function(){
            //     console.log("window.onload");
            //
            // };
            window.onhashchange = function(){
                clearInterval(window.timesTdody);
            }
        ...
        methods: {
            ...
            circleNumber: function(number,callback=function () {
                ...
                .always((data)=>{
                    ...
                    base.ajaxCallback(data,()=>{
                            ...
                            let echarts = require('echarts/lib/echarts');
                                    ...
                                    // 为echarts对象加载数据 
                                    setTimeout(function(){
                                        that.orderNumberChart = echarts.init(document.getElementById('main')); 
                                        that.orderNumberChart.setOption(option);
                                    },1000);
            ...
            getOrderNumber: function(number,callBack = function(){}){
                this.orderItems = [];
