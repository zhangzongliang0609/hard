        ...
        <div class="page-container">
            <div class="panel panel-default radius">
                <div class="panel-body">
                    <span class="f-20 fw-b">车辆管理</span>
                </div>
            </div>
            ...
            <div class="cl mt-10 mb-10 pt-10 pb-10">
                ...
                <a id="exportData" class="btn btn-secondary radius f-r ml-15" v-on:click="exportData()">批量导出</a>
                <a href="javascript:;" class="btn btn-secondary radius f-r ml-15" v-on:click="turnToImport()">批量导入</a>
                <a class="btn btn-secondary radius mr-5 f-r" href="javascript:;" v-on:click="clickAdd()"><i class="Hui-iconfont">&#xe600;</i> 添加车辆
                </a>
            </div>
    ...
    export default{
        ...
        data:function(){
            return {
                ...
                isShowDetails:false,
                details:{},
                port:base.gAjaxUrl.officialcarVehicleList_V2,
                importData: {},
        ...
        methods: {
            ...
            toggleLock:function(officialcarVehicle) {
                ...
                officialcarVehicle.locked ? url = base.gAjaxUrl.officialcarVehicleList_V2 + officialcarVehicle.id + "/" : url = base.gAjaxUrl.officialcarVehicleList_V2 + officialcarVehicle.id + "/" ;
                this.itemsLoading = true;
                $.ajax({
                    url: url,
                    type: 'PATCH',
                    data:{
                        locked: officialcarVehicle.locked ? false : true,
                    }
                }).always((data)=>{
