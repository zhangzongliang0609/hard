                ...
                <div class="pd-15 clearfix">
                    <div class="clearfix pb-5">
                        ...
                        <div class="text-l clearfix f-l mr-15">
                            <input id="searchInput" v-model="searchInput" type="text" placeholder="流程名称/部门/姓名" style="width:250px" class="input-text"><button v-on:click="getList(1)" class="btn btn-success radius-r" type="button"><i class="f-r Hui-iconfont">&#xe665;</i></button>
                        </div>
                    </div>
                </div>
        ...
        methods: {
                ...
                layer.confirm(`确认删除【${item.approv_name}】流程？`, (index) => {
                    ...
                    $.ajax({
                        ...
                        if(!data) {
                            ...
                            if(repairOps.param.page > 1 && this.items.length == 1) {
            ...
            getList: function (reset = 0) {
                ...
                if (reset) {
                    ...
                    repairOps.param[this.searchType] = $("#searchInput").val();
                }
            ...
            getNode (item) {
                if(item.approv_nodes.length) {
                    ...
                    approve.forEach((progress) => {
                        str += this.getName(progress.approvers, 'real_name',progress.condition) + ' → ';
                    });
