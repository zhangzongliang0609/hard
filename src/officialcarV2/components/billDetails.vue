<template>
    <order v-if="isShowOrder" @dialog-close="closeOrder" :data="dialogData" :type="'bill'"></order>
...
<script>
    ...
    import order from "../components/officialOrderDetail"
    import maintain from './vehicleRepairDetail'
    ...
    export default{
        ...
        props:['item','start','end','state','datekey'],
        data:function () {
            return{
                noData:false,
                startDateInput:'',
        ...
        methods:{
            ...
            queryAjax:function(callback=function(){}){
                ...
                //修改参数
                $.ajax({
                    url: `${base.gAjaxUrl.officialcarBillList_V2}car_fee_list/`,
                    type: 'GET',
                    data:{
            ...
            exportBill:function () {
                ...
                $.ajax({
                    url: `${base.gAjaxUrl.officialcarCost_V2}statlist_export/`,
                    type:'GET',
                    data:ajaxData
                }).always((data)=>{
                    base.ajaxCallback(data,()=>{
