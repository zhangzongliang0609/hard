...
<template>
    <li>
        ...
        <ul v-show="open" v-if="isFolder" :class="{autoWidth: params.autoWidth}">
            <item v-on:item-click="itemClick" v-on:item-dbl="itemDblClick" @item-dbl-no-add="itemDoubleClickNoAdd" v-on:item-del="itemDelete" class="item"
...
//                console.log(Tag, this.model.department_name);
            ...
            itemDoubleClickNoAdd:function(data){
                this.$dispatch("double-click",data);
            },
...
//                        console.log("departmentClick - ", this.model.department_name);
                    ...
                    add: function () {
                        ...
                        if(this.params.doubleClick){
                            this.$dispatch("item-dbl-no-add", this.model);
                        }
