                ...
                <div class="employeeContainer col-7 f-l">
                    <div class="employeeBox">
                        <div class="clearfix staff_search">
                            ...
                            <!--公务车申请规则-->
                            <div v-if="official_apply" class="f-r">
                                <span class="f-l lh-31 ml-10 mr-10">订单状态</span>
                                <select class="select-box f-l" v-model="orderStatus">
                                    <option value="-20">已驳回</option>
                                    <option value="-10">已取消</option>
                                    <option value="10">审批中</option>
                                    <option value="20">待派单</option>
                                    <option value="30">待接送</option>
                                    <option value="40">接送中</option>
                                    <option value="50">已完成</option>
                                    <option value="60">已评价</option>
                                </select>
                            </div>
                        </div>
...
<script type="text/ecmascript-6">
    ...
    export default{
        ...
        props: ['is_single', 'list',"official_apply"],
        data: function () {
            return {
                noData: false,
                items: [],
...
//                console.log("departmentEmployee - departmentDelClick：", data);
            ...
            confirm: function () {
                if(this.official_apply){
                    this.$dispatch('sel-save', this.selectedNameList,this.orderStatus);
                }else{
