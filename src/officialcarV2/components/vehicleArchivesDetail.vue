	...
	<div class="layui-layer layui-anim layui-layer-page layui-modify vehicle_archives_box">
		...
		<div class="layui-layer-content pr-20" id="vehicle_container">
			<div class="top-box cl">
				<div class="vehicle_content_title lh-16 pl-10">
					<div class="f-18 fw-b mt-5 mb-5">基本信息：</div>
				...
				<div class="vehicle_content_title lh-16 pl-10">
					<div class="f-18 fw-b mt-5 mb-5">使用信息：</div>
					<div class="f-l vehicle_title_item pr-20 mb-5">
						行驶里程：{{vehicleInfo.order_cnt}}
					</div>
					<span class="f-l">|</span>
					<div class="f-l vehicle_title_item pr-20 pl-20">
						订单数：{{vehicleInfo.order_cnt}}
					</div>
					<span class="f-l">|</span>
					<div class="f-l vehicle_title_item pr-20 pl-20">
						订单里程：{{vehicleInfo.order_mileage}}
					</div>
					<span class="f-l">|</span>
					<div class="f-l vehicle_title_item pr-20 pl-20">
						订单时长：{{vehicleInfo.durations}}
					</div>
					<span class="f-l">|</span>
					<div class="f-l vehicle_title_item pr-20 pl-20">
						总费用：{{vehicleInfo.vehicle_fee + vehicleInfo.order_fee + vehicleInfo.repair_fee}}
					</div>
					<span class="f-l">|</span>
					<div class="f-l vehicle_title_item pr-20 pl-20">
						订单费用：{{vehicleInfo.order_fee}}
					</div>
					<span class="f-l">|</span>
					<div class="f-l vehicle_title_item pr-20 pl-20">
						车辆费用：{{vehicleInfo.vehicle_fee}}
					</div>
					<span class="f-l">|</span>
					<div class="f-l vehicle_title_item pr-20 pl-20">
						维修费用：{{vehicleInfo.repair_fee}}
					</div>
				</div>
			</div>
