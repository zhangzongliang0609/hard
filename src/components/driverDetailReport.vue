<template>
    ...
    <div class="page-container">
        <div class="cl pd-5 bg-1 bk-gray"> 
            <span class="l">
                ...
                <div class="l m-info ml-10">
                    <div class="l item">{{tempItems.staff_vo.real_name}}/{{tempItems.staff_vo.sex==1? '男': '女';}}</div>
                    <div class="l item">电话:{{tempItems.staff_vo.phone}}</div>
                    <div class="l item">工号:{{tempItems.staff_vo.job_number}}</div>
                    <div class="l item">总行驶里程:{{tempItems.mileage_cnt}}</div>
        ...
        <div class="text-l mt-20"> 
            关键字：
            <input type="text" class="input-text Wdate mr-5" style="width:150px;" placeholder="站点/出发时间" id="searchInput">
            ...
            <!-- specific导出数据按钮 -->
            <!-- <span class="l">
                <a class="btn btn-success radius" href="javascript:;" v-on:click="getList()">
            ...
            <table class="table table-border table-bordered table-hover table-bg mt-20" >
                ...
                <tbody>
                    <tr class="text-c" v-for="item in items">
                        ...
                        <!-- <td>-</td> -->
                        <td class="comment-td">
                            {{item.comment_vo.score}}分/{{commentTxt(item.comment_vo.comment)}}
...
//                this.$route.router.go({path: '/driverReport', replace: true});
