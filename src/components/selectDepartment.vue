            ...
            <div class="inner_container">
                ...
                <div class="selectContainer relative">
                    ...
                    <div class="containerInner">
                        <div class="relative folder"
                             v-for="item in departsArr"
                             track-by="$index">
                            {{getDepartmentName(item)}}
                            <span class="removeDepartment layui-layer-ico"
                                  @click="removeSelect($index)"></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    export default{
        ready () {
            ...
            if(this.is_double_click){
                this.treeParams.add = true;
            }
            if(this.dbl_selected_child){
                this.treeParams.dblSelectedChild = true;
            }

        },
        props: ['departs', 'is_single' ,'is_double_click','dbl_selected_child'],
        data: function () {
            return {
                currentDepartment: {},
                departmentData: {},
...
//                    this.departsArr = [data]; // 有效
            ...
            selectAllDepartments: function () {
                this.departsArr = this.addDeparts(this.treeData.child, []);
            },
            ...
            departmentDblClick: function (data) {
                console.log("departmentDblClick");
                console.log(data);
