...
<div class="layui-layer layui-anim layui-layer-page layui-modify">
    ...
    <div class="layui-layer-content">
        <form id="J-layer-form" class="form form-horizontal layui-layer-wrap">
            <div class="row cl">
                <label class="form-label f-l col-4 "><span class="c-red">*</span>报修类型：</label>
                <div class="formControls f-l col-4">
                    <input v-model="typeNameInput" type="text" class="input-text" value="" placeholder="" name="type_name">
                </div>
            </div>
        </form>
    </div>
...
import * as base from '../assets/js/base.js';
    ...
    export default{
        ready () {
            ...
            //类型判断
            if(this.type == 'add'){
                ajaxUrl = base.gAjaxUrl.repairtypes;
                ajaxType = 'POST';
            }else if(this.type == 'modify'){
                ajaxUrl = `${base.gAjaxUrl.repairtypes}${getData.id}/`;
                ajaxType = 'PUT';
