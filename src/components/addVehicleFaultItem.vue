...
<div class="layui-layer layui-anim layui-layer-page layui-modify">
    ...
    <div class="layui-layer-content">
        <form onkeydown="if(event.keyCode==13)return false;" id="J-layer-form" class="form form-horizontal layui-layer-wrap">
            <div class="row cl">
    ...
    <div class="layui-layer-btn">
        <a class="layui-layer-btn0" v-on:click="save">确认</a>
...
import * as base from '../assets/js/base.js';
    ...
    export default{
        ready () {
            ...
            //类型判断
            if(this.type == 'add'){
                ajaxUrl = base.gAjaxUrl.vehicleFaultitems;
                ajaxType = 'POST';
            }else if(this.type == 'modify'){
                ajaxUrl = `${base.gAjaxUrl.vehicleFaultitems}${getData.id}/`;
                ajaxType = 'PATCH';
