    ...
    <div class="layui-layer layui-anim layui-layer-page layui-modify">
        ...
        <div class="layui-layer-content">
            <form id="J-layer-form" class="form form-horizontal layui-layer-wrap">
                ...
                <div class="row cl">
                    <label class="form-label f-l col-4 "><span class="c-red" v-if="passwordFlag">*</span>密码：</label>
                    <div class="formControls f-l col-4">
                        <input id="password" v-model="passwordInput" type="password" class="input-text" value="" placeholder="" name="password">
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label f-l col-4 "><span class="c-red" v-if="passwordFlag">*</span>确认密码：</label>
                    <div class="formControls f-l col-4">
    ...
    export default{
        ready () {
            ...
            if(this.type == 'add'){
                ...
                setTimeout(() => {
                    this.sexSelected = staffData.sex;
                });
                ...
                this.employeeTagsArr = staffData.tags ? staffData.tags : [];
                this.driverTagsArr = getData.tags ? getData.tags : [];
            }
...
//                        password: that.passwordInput,
            ...
            save:function(){
                ...
                if(this.type == 'add' && this.passwordInput === ''){
                    this.passwordFlag = true;
            ...
            addDriver:function(data){
                ...
                let url = base.gAjaxUrl.officialcardrivers;
                let type = "POST";
                ...
                let ajaxData = {
                    tags_set: this.driverTagsArr.map(item => item.id)
                };
                if(this.type == 'add'){
                    ajaxData["staff"] = data.id;
                }
                $.showLoading();
                $.ajax({
                    url:url,
