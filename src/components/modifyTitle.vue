...
<div class="layui-layer layui-anim layui-layer-page layui-modify">
    ...
    <div class="layui-layer-content">
        <form id="J-layer-form" class="form form-horizontal layui-layer-wrap">
            <div class="row cl">
                <label class="form-label f-l col-4 "><span class="c-red">*</span>提示标题：</label>
                <div class="formControls f-l col-4">
                    <input v-model="titleInput" type="text" class="input-text" value="" placeholder="" name="title">
                </div>
            </div>
        </form>
    </div>
    ...
    export default{
        ready () {
            ...
            if(this.type == 'add'){
                ...
                ajaxType = 'PUT';
                this.billNameInput = getData.value;
            }
