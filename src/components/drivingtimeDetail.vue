<template >
    ...
    <div class="layui-layer layui-layer1 layui-anim layui-layer-page layui-modify">
        <div class="layui-layer-title">
            <div class="titlecomm f-l f-20 ">时长分布明细</div>
  ...
  // 引入基本模板
    ...
    export default{
        ready () {
            ...
            if(this.data['range_start'] == 0 && this.data['range_end'] == 1){
                this.order_name = '0-1h';
            }
            if(this.data['range_start'] == 1 && this.data['range_end'] == 3){
                this.order_name = '1-3h';
            }
            if(this.data['range_start'] == 3 && this.data['range_end'] == 6){
                this.order_name = '3-6h';
            }
            if(this.data['range_start'] == 6 && this.data['range_end'] == 12){
                this.order_name = '6-12h';
            }
            if(this.data['range_start'] == 12 && this.data['range_end'] == 24){
                this.order_name = '12-24h';
            }
            if(this.data['range_start'] == 24 && this.data['range_end'] == 'max'){
                this.order_name = '>24h';
            }
            // this.order_num = this.data.order_num;
            this.start_duration = this.data['range_start'];
            this.end_duration = this.data['range_end'];
        ...
        methods: {
            ...
            getOrders: function (callback=function () {}) {
                ...
                staffsOps.param.start_duration = that.start_duration,
                staffsOps.param.end_duration = that.end_duration,
                $.ajax({
