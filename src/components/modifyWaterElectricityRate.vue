<template>
    ...
    <div class="layui-layer layui-anim layui-layer-page layui-modify room-inner">
            ...
            <form id="J-layer-form-room-inner" class="form form-horizontal layui-layer-wrap mPersonalRateForm" >
                <div class="row cl" track-by="$index" v-for="fee in fees">
                    ...
                    <div class="f-l col-3 pl-20">
                        <input :disabled="type == 'check'" type="number" class="ratesInput" v-bind:class="'cmr' + fee.feetype_id" v-bind:value="fee.point | getPoint" placeholder="" name="{{'nmr' + fee.feetype_id}}">
                    </div>
        ...
        <div v-if="noData" class="no-data text-c">当前计费单无费率信息</div>
        <span class="layui-layer-setwin">
            <a class="layui-layer-ico layui-layer-close layui-layer-close1" href="javascript:;" v-on:click="close()"></a>
        </span>
        <div v-if="type == 'set'" id="save" class="layui-layer-btn" v-on:click="save" v-show="fees.length"><a class="layui-layer-btn0">保存</a></div>
    </div>
            ...
            getFeeList: function () {
                ...
                $.ajax({
                    ...
                    base.ajaxCallback(data,()=>{
                        this.fees = data || [];
                        this.noData = this.fees.length ? false : true;
