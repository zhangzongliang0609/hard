...
<div class="layui-layer layui-anim layui-layer-page layui-modify">
    ...
    <div class="layui-layer-content pd-20">
        <div class="layui-layer-wrap">
            <div class="text-l clearfix">
                <input id="searchInput" type="text"  autocomplete="off" placeholder="姓名/工号/电话/部门/职位" style="width:250px" class="f-l input-text">
    ...
    <div class="layui-layer-btn" v-on:click="next"><a class="layui-layer-btn0">添加</a></div>
</div>
    ...
    export default{
        ...
        methods: {
            ...
            queryAjax:function(callback=function(){}){
                ...
                let ajaxUrl =base.gAjaxUrl.staffs;
                $.ajax({
                    url: ajaxUrl,
                    type: 'GET',
