...
<script type="text/ecmascript-6">
    ...
    import quarterly from "./ferryupdateQuarterly"
    import annual from "./ferryupdateAnnual"
    import insurance from "./ferryupdateInsurance"
    import maintenance from "./ferryMaintenance"
    ...
    export default{
        ...
        data: function () {
            return {
                ...
                show: '',
                type:base.gAjaxUrl.ferryBusList
            }
        },
        methods: {
            close: function () {
